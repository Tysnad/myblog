...
class Article(models.Model):
    ...
    update_time=models.DateTimeField("更新时间")
    create_time=models.DateTimeField("创建时间")
    content = UEditorField(height=300,width=1000,default='',blank=True,imagePath='uploads/blog/images',toolbars='besttome',filePath='uploads/blog/files',verbose_name='文章内容')
    def __unicode__(self):
        return self.title
